                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <h6 class=" text-gray-900 mb-2">Manufacturer Login</h6>
                                    </div>
                                    <form class="user" method="POST" action="{{ route('manufactuer.login') }}">
                                        @csrf
                                        ...
                                        <a href="{{ route('login_retailer') }}"
                                            class="btn btn-facebook btn-user btn-block">
                                            <i class="fas fa-shopping-bag fa-fw"></i> Retailer
                                        </a>
                                    </form>
